...
int main(int argc, char** argv)
{
...

    {
        ...
        // print here should say ID the components that have been connected
        ...
        // (probably connection to the url stated in the terminal command line)
        if (argc == 2) {
        ...
        // display that the connection was a failure
    ...
    // SYSTEM HAS BEEN CONNECTED AND WE ASSOCIATE MAVSDK STUFF TO IT
    auto system = mavsdk.systems().at(0);
    auto action = Action{system};
    auto mission = Mission{system};
    auto telemetry = Telemetry{system};

    // check telemetry.health_all_okay to see if the UAV is operational
    ...
    // data type that holds the mission items
    ...
    // UPLOAD THE MISSION
    {
        ...
        // make a mission plan object
        Mission::MissionPlan mission_plan{};
        // add items to the mission plan object
        mission_plan.mission_items = mission_items;
        // upload mission plan items
        mission.upload_mission_async(
            mission_plan, [prom](Mission::Result result) { prom->set_value(result); });

        // check if mission plan successfully uploaded
    ...
    // ARM THE AIRCRAFT TO START A NEW MISSION
